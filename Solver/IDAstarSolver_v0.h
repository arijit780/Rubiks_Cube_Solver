...
#ifndef RUBIKS_CUBE_SOLVER_IDASTARSOLVER_v0_H
#define RUBIKS_CUBE_SOLVER_IDASTARSOLVER_v0_H

// Typename T: RubiksCube Representation used (3d, 1d, Bitboard)
// Typename H: Corresponding Hash function

template<typename T, typename H>
class IDAstarSolver_v0 {
private:
    ...
    pair<T, int> IDAstar(int bound) {
        ...
        // assuming estimate to be 0 i.e., without implementing the Pattern Database Files
...
public:
    ...
    IDAstarSolver_v0(T _rubiksCube) {
...
#endif //RUBIKS_CUBE_SOLVER_IDASTARSOLVER_v0_H