...
#define RUBIKS_CUBE_SOLVER_RUBIKSCUBE_H
    ...
    /* This is a base class for all Rubik's cube representation. We are going to
     * implement 3 different representations of Rubik's cube. 
     * This class is an abstract class that provides a shared functionality for 
     * all the representations and models.
     */
